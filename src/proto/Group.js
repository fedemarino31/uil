...
export class Group extends Proto {
  constructor(o = {}) {
    ...
    this.c[2] = this.dom(
      ...
      this.css.basic +
        flexible +
        "width:100%; left:0;  overflow:hidden; top:" +
        this.h +
        "px"
    );
    this.c[3] = this.dom(
      ...
      this.css.basic +
        ...
        fltop +
        "px;",
      { d: this.svgs.g1, fill: cc.text, stroke: "none" }
    );
  ...
  add() {
    ...
    // Si el grupo está abierto, actualiza inmediatamente layout y altura
    if (this.isOpen && u) {
      // ajustar el nuevo hijo y recalcular alturas hacia arriba
      u.setSize(this.w);
      u.rSize();
      this.parentHeight(); // propaga a Tabs/GUI contenedor
    }
