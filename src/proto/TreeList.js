...
export class TreeList extends Proto {
    ...
    build() {
        ...
        while (node) {
            ...
            const container = this.dom('div', this.css.basic + 'display:flex;' + (isLeaf ? 'flex-direction:column;' : 'flex-direction:row;'));
            container.style.height = (isLeaf ? this.maxLeaf * this.h : this.h) + 'px';
