...
(function (global, factory) {
	...
	class Gui {
		constructor(o = {}) {
			...
			this.tabBar = Tools.dom("div", this.css.basic + "left:0; top:0; width:100%; height:" + this.tabBarHeight + "px; background:" + cc.background + "; display:none; pointer-events:auto; display:flex;");
		...
		addTab(tab) {
			...
			const cc = this.colors;
			const b = Tools.dom('div', this.css.basic + this.css.button + 'position:relative; padding:0 8px; height:' + this.tabBarHeight + 'px; line-height:' + (this.tabBarHeight - 2) + 'px; background:' + cc.button + '; color:' + cc.text + '; border:' + cc.borderSize + 'px solid ' + cc.border + '; border-radius:' + cc.radius + 'px; cursor:pointer; pointer-events:auto;');
		...
		setHeight() {
			...
			if (this.isOpen) {
				this.h = this.calcUis();
				let hhh = this.forceHeight ? this.forceHeight + this.zone.y + this.offset : window.innerHeight;
